...
class Blade(Hero):
    def __init__(self):
        ...
        self.AGL = 10
        self.name = "Blade"
        self.intel = """Blade (Блэйд) - Ловкий и обученый разным приёмам ассасин. Своим клинком он может безо всяких проблем рассекать врагов и других чемпионов.
Сбалансированный во всех областях чемпион. Прост и понятен для абсолютно каждого, кто захочет поиграть в Омега Дуэль.
Взмах клинком - базовая атака, наносящая неплохой урон.
Сбить баланс - атака с неплохим уроном, главная фишка которой: временное снижение силы оппонента. 
Рассечение - очень мощная атака за очень мощную цену. Используйте с умом.
Мстительная тень - Каждое уклонение усиливает вас до конца боя!
Добивающий приём - Мгновенно разбирается с достаточно побитыми противниками, в другом случае: наносит весомый урон!"""
...
class GlassJoe(Hero):
    def __init__(self):
        ...
        self.AGL = 20
        self.name = "Glass Joe"
        self.intel = '''Glass Joe (Стеклянный Джо) - Инжинер с любовью к револьверам и причудливым улучшениям. Иногда любит поиграть ковбоем, оттачивая свои навыки стрельбы.
Чистого рода стеклянная пушка. Громадный урон, громадная хрупкость. Ваша лучшая стратегия - побеждать быстро, и никак иначе.
Верный шестизарядник - Наносит высокий урон. Другого и не надо.
Разгон - Временно увеличивает вам ловкость.'''
